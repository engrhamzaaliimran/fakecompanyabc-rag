...
"""
07_evaluate_rag_ragas.py

Robust generation evaluation for FakeCompanyABC RAG.
...
Normal full run:
    python 07_evaluate_rag_ragas.py

Smoke test:
    python 07_evaluate_rag_ragas.py --limit 3

Resume interrupted run:
    python 07_evaluate_rag_ragas.py --resume
"""
...
def main():
    ...
    print(
        "FAKECOMPANYABC ROBUST GENERATION EVALUATION"
    )
